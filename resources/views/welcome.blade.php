...
<body>
    ...
    <section id="profile">
        <div class="container relative mx-auto h-full py-8">
            <div class="relative hidden md:block md:h-[720px] md:w-[720px]">
                <img loading="lazy" class="rounded-xl object-cover w-full h-full shadow-sm" src="/hero/about.webp"
    ...
    <section id="activities" class="bg-dot-ornament bg-gray-100">
        <div class="container mx-auto flex flex-col-reverse items-center gap-8 py-16 md:flex-row">
            ...
            <div class="basis-1/2">
                <div>
                    <div class="text-center text-5xl font-bold text-primary md:text-left md:text-7xl"> KBPU </div>
                    <div class="text-center text-xl text-gray-600 md:text-left md:text-3xl">
    ...
    <section id="contact">
        <div class="container mx-auto py-16">
            <h1 class="text-center text-3xl font-bold leading-loose">Hubungi Kami</h1>
    ...
    <footer class="bg-primary text-white">
        <div class="container grid grid-cols-1 gap-4 p-8 sm:px-12 md:grid-cols-2 md:px-32">
            <div>
        ...
        <div class="flex items-center justify-center">
            <div class="w-[300px] rounded-xl bg-white px-8 py-2 shadow-sm">
                <img src="/icon/logo.svg" alt="PT Baja Titian Utama" />
            </div>
        </div>
...
<script lang="javascript">
    const select = document.querySelector('#nav-menu');
